...
$select_chat = $conn->prepare("SELECT DISTINCT msg_id,outgoing_msg_id,msg,incoming_msg_id FROM mess WHERE outgoing_msg_id ='$receiver_id' AND incoming_msg_id='$sender_id'
                            || outgoing_msg_id ='$sender_id' AND incoming_msg_id='$receiver_id' ORDER BY msg_id ASC");
$select_chat->execute();
